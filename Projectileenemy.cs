 ...
 * 
 * This class handles movement, collision detection with the player,
...
public partial class Projectileenemy : CharacterBody2D
{
	 ...
	 * 
	 * Applies damage to the player when hit and destroys the projectile.
	 * Also destroys the projectile when colliding with environment
